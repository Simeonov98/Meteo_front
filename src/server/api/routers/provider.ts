...
export const providersRouter = createTRPCRouter({
  ...
  //   const groupByResult = await ctx.prisma.dalivali.groupBy({
  //     by: ["forecastDay", "createdAt"],
  //     where: {
  //       forecastDay: {
  //         gt: new Date(Date.now()),
  ...
  //       }
  //     },
  //     orderBy: [{ createdAt: "asc" }, { forecastDay: "asc" }],
  //     _avg: { tmax: true, tmin: true, }
  ...
  //     avgTmax: number;
  //     avgTmin: number;
  //   }[]  = groupByResult.reduce((acc, group) => {
  //     const { forecastDay, createdAt } = group;
  //     const { tmax, tmin } = group._avg;
